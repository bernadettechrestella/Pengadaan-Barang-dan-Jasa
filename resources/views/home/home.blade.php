                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box">
                            ...
                            <p>Bagi kamu yang memiliki usaha sudah lama atau sama dengan 3 tahun, bisa mengajukan pengajuan</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box">
                            ...
                            <p>Usaha kamu wajib berbadan hukum minimal CV dan sudah terdaftar sekurang nya 3 tahun.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
                        <div class="icon-box">
                            ...
                            <p>Untuk rekening usaha wajib terpisah dengan rekening pribadi.</p>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="zoom-in">
                ...
                <div class="row">
                    <div class="col-lg-9 text-center text-lg-start">
                        ...
                        <p>Kamu dapat datarkan usaha kamu agar dapat mengajukan pengajuan dari setiap bidang yang dibutuhkan.</p>
                    </div>
